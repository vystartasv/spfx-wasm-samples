...
export default class WasmDuplicateDetector extends React.Component<IWasmDuplicateDetectorProps, State> {
  private readonly ids = `duplicate-detector-${++nextInstanceId}`;
